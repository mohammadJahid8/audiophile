...
const Footer = () => {
    return (
        <div>
            <div className="px-4 pt-16 mx-auto  md:max-w-full  md:px-16 lg:px-16 bg-[#101010] mt-44">
                <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                    <div className="sm:col-span-2">
                        <a
                            ...
                            aria-label="Company"
                            title="Company"
                            class="inline-flex items-center text-white font-extrabold"
                        >
                            <FontAwesomeIcon icon={faHeadphonesSimple} className=" h-10" />
                            <span class="ml-2 text-2xl tracking-wide">
                                audiophile
                            </span>
                        </a>
                    ...
                    <div>
                        ...
                        <div className="flex items-center mt-1 space-x-3">
                            <a
                                href="/"
                                className="text-gray-400 transition-colors duration-100 hover:text-[#d87d4a]"
                            >
                        ...
                        <p className="mt-4 text-sm text-gray-400">
                            Get Connected In Our Social To Know More About Us
                        </p>
                    </div>
                </div>
                <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
                    <p className="text-sm text-gray-300">
                        © Copyright 2020 AudioPhile. All rights reserved.
                    </p>
